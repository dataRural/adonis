...
const routes = {
  ...
  'datasets.version.download_all': {
    ...
    tokens: [{"old":"/datasets/:datasetId/version/:versionId/download-all","type":0,"val":"datasets","end":""},{"old":"/datasets/:datasetId/version/:versionId/download-all","type":1,"val":"datasetId","end":""},{"old":"/datasets/:datasetId/version/:versionId/download-all","type":0,"val":"version","end":""},{"old":"/datasets/:datasetId/version/:versionId/download-all","type":1,"val":"versionId","end":""},{"old":"/datasets/:datasetId/version/:versionId/download-all","type":0,"val":"download-all","end":""}],
    types: placeholder as Registry['datasets.version.download_all']['types'],
  },
  'datasets.version.readme.download': {
    methods: ["GET","HEAD"],
    pattern: '/datasets/:datasetId/version/:versionId/readme/download',
    tokens: [{"old":"/datasets/:datasetId/version/:versionId/readme/download","type":0,"val":"datasets","end":""},{"old":"/datasets/:datasetId/version/:versionId/readme/download","type":1,"val":"datasetId","end":""},{"old":"/datasets/:datasetId/version/:versionId/readme/download","type":0,"val":"version","end":""},{"old":"/datasets/:datasetId/version/:versionId/readme/download","type":1,"val":"versionId","end":""},{"old":"/datasets/:datasetId/version/:versionId/readme/download","type":0,"val":"readme","end":""},{"old":"/datasets/:datasetId/version/:versionId/readme/download","type":0,"val":"download","end":""}],
    types: placeholder as Registry['datasets.version.readme.download']['types'],
  },
  'datasets.version.file.download': {
    methods: ["GET","HEAD"],
    pattern: '/datasets/:datasetId/version/:versionId/file/:fileId/download',
    tokens: [{"old":"/datasets/:datasetId/version/:versionId/file/:fileId/download","type":0,"val":"datasets","end":""},{"old":"/datasets/:datasetId/version/:versionId/file/:fileId/download","type":1,"val":"datasetId","end":""},{"old":"/datasets/:datasetId/version/:versionId/file/:fileId/download","type":0,"val":"version","end":""},{"old":"/datasets/:datasetId/version/:versionId/file/:fileId/download","type":1,"val":"versionId","end":""},{"old":"/datasets/:datasetId/version/:versionId/file/:fileId/download","type":0,"val":"file","end":""},{"old":"/datasets/:datasetId/version/:versionId/file/:fileId/download","type":1,"val":"fileId","end":""},{"old":"/datasets/:datasetId/version/:versionId/file/:fileId/download","type":0,"val":"download","end":""}],
    types: placeholder as Registry['datasets.version.file.download']['types'],
  },
  'datasets.explore': {
    methods: ["GET","HEAD"],
    pattern: '/datasets',

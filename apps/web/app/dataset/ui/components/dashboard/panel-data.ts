...
export const MY_STATS: PanelStatItem[] = [
...
export const MY_DATASETS: UserDatasetItem[] = [
  {
    id: 1,
  ...
  {
    id: 2,
    title: 'Radiação Solar e Evapotranspiração — Baixada Fluminense',
    unit: 'Instituto de Ciências Exatas',
    format: 'CSV',
  ...
  {
    id: 3,
    title: 'Índices Climáticos Mensais — Campus UFRRJ',
    unit: 'Instituto de Ciências Exatas',
    format: 'CSV',
    tint: 'var(--brand-blue)',
    status: 'review',
  ...
  {
    id: 4,
    title: 'Séries de Precipitação Horária — Rede Automática',
    unit: 'Instituto de Ciências Exatas',
    format: 'Parquet',
    tint: 'var(--brand-teal)',
    status: 'published',
  ...
  {
    id: 5,
    title: 'Qualidade do Ar — Estações de Monitoramento RJ',
    unit: 'Instituto de Ciências Exatas',
    format: 'CSV',
  ...
  {
    id: 6,
    title: 'Balanço Hídrico Climatológico — Seropédica',
    unit: 'Instituto de Ciências Exatas',
    format: 'CSV',
  ...
  {
    id: 7,
    title: 'Velocidade e Direção do Vento — Torre Anemométrica',
    unit: 'Instituto de Ciências Exatas',
    format: 'CSV',
    tint: 'var(--brand-sky)',
    status: 'review',
  ...
  {
    id: 8,
    title: 'Temperatura do Solo por Profundidade (2018–2023)',
    unit: 'Instituto de Ciências Exatas',
    format: 'CSV',
    tint: 'var(--brand-orange)',
    status: 'unpublished',
...
export const TYPE_LABEL = { num: 'Número', text: 'Texto', date: 'Data', geo: 'Geo' }
